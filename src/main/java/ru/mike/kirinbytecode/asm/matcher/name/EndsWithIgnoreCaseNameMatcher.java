...
public class EndsWithIgnoreCaseNameMatcher<T> extends NameMatcher<T> {
     ...
     */
    public EndsWithIgnoreCaseNameMatcher() {}

    public EndsWithIgnoreCaseNameMatcher(String value, MatcherMode mode) {
        super(value, mode);
    }

    @Override
    public <R> boolean isCurrentNameMatcher(NameMatcher<R> nameMatcher) {
        return nameMatcher instanceof EndsWithIgnoreCaseNameMatcher;
    }
    ...
    public List<Method> findSuitableMethods(List<Method> methods) {
        ...
        for (Method method : methods) {
            ...
            if (methodName.toLowerCase().endsWith(getValue().toLowerCase())) {
